...
import br.com.compasso.usuarios.dto.login.LoginDto;
import br.com.compasso.usuarios.form.login.LoginForm;
...
public class LoginController {
	...
	@PostMapping
	public ResponseEntity<LoginDto> autenticar(@RequestBody @Valid LoginForm form) throws CustomNotFoundException {
